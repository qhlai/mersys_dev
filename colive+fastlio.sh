...
gnome-terminal -t "roslaunch" -x bash -c "catkin_make;source ./devel/setup.bash;roslaunch colive_backend colive_backend.launch;exec bash;"

sleep 3

gnome-terminal -t "roslaunch" -x bash -c "source ./devel/setup.bash;roslaunch fast_lio mapping_avia_client.launch;exec bash;"

#gnome-terminal -t "roslaunch" -x bash -c "catkin_make;source ./devel/setup.bash;roslaunch r3live r3live_bag.launch;exec bash;"
