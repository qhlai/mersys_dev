...
int main(int argc, char* argv[]) {
    ...
    // m_map_output_dir =Common_tools::get_home_folder().append( "/mersys_output" );
    g_cost_time_logger.init_log( std::string(mersys_params::sys::output_dir).append("/cost_time_logger.log"));
    ...
    // mersys::TypeDefs::ThreadPtr thread_comm_;
