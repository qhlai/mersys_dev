...
MapManager::MapManager()
{
    ...
    // if(mersys_params::placerec::type == "MERSYS" || mersys_params::placerec::type == "MERSYS_G") {
    //     database_.reset(new KeyframeDatabase(voc_));
    // } else {
    //     std::cout << COUTFATAL << "Place Recognition System Type \"" << mersys_params::placerec::type << "\" not valid" << std::endl;
    //     exit(-1);
    // }
...
gtsam::Pose3 Transform2Pose3(mersys::TypeDefs::TransformType T){
