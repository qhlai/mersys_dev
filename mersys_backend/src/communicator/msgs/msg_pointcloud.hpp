...
//     template<class Archive>
//     inline
//     void save(Archive& ar, const mersys::TypeDefs::QuaternionType& q) {
//         ar(q.x());
//         ar(q.y());
//         ar(q.z());
//         ar(q.w());
...
//     template<class Archive>
//     inline
//     void load(Archive& ar, mersys::TypeDefs::QuaternionType& q) {
//        mersys::TypeDefs::precision_t  x, y, z, w;
//         ar(x);
//         ar(y);
//         ar(z);
//         ar(w);
//         q = mersys::TypeDefs::QuaternionType(w, x, y, z);
//     }
// } 
