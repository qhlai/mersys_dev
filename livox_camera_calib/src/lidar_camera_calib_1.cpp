#include "include/lidar_camera_calib_1.hpp"
...
int main(int argc, char **argv) {
  ...
  cv::imwrite("/home/uestc/dataset/r3live_offical/single_scene_calibration/init.png", init_img);
  cv::waitKey(1000);
  ...
  cv::imwrite("/home/uestc/dataset/r3live_offical/single_scene_calibration/opt.png", opt_img);
  cv::waitKey(1000);
